...
namespace CommLib.BdPush
{
    ...
    /// </summary>
    public class Topic_Query_List : Baidu_Send
    {

        #region 构造函数
        public Topic_Query_List(string secret_key, Baidu_Mod mod)
        {
        ...
        public Topic_Query_List(string httpMehtod, string secret_key, Baidu_Mod mod)
        {
